...
public final class CommonAppConstants {
    ...
    public static final String USER_NAME_JSP_PARAM = "userName";
    public static final String USER_EMAIL_JSP_PARAM = "userEmail";
    public static final String USER_PASSWORD_JSP_PARAM = "userPassword";
    public static final String USER_PASSWORD_CONFIRM_JSP_PARAM = "userPasswordConfirm";
    public static final String USER_ADDRESS_JSP_PARAM = "userAddress";
    public static final String DEFAULT_USER_PHONE_NUMBER_JSP_PARAM = "default.user.phoneNumber";
    public static final String USER_PHONE_NUMBER_JSP_PARAM = "userPhoneNumber";
